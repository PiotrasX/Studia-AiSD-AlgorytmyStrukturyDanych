...
// Implementacja kolejki za pomocą klasy ArrayList - stos złożonych obiektów zdefiniowanych przez użytkownika,
...
public class B3KolejkaArrayList
{
    private ArrayList<Integer> kolejka;

    public B3KolejkaArrayList() { kolejka = new ArrayList<Integer>(); }
    ...
    {
        B3KolejkaArrayList kolejka = new B3KolejkaArrayList();
