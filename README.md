...
- `Zadania/Problemy Informatyczne/src` – Zadania realizowane samodzielnie jako rozszerzenie i utrwalenie materiału. Obejmują problemy algorytmiczne wymagające zastosowania różnych paradygmatów projektowania algorytmów (dziel i zwyciężaj, programowanie dynamiczne, algorytmy zachłanne, podejście probabilistyczne). Celem tej części repozytorium jest rozwinięcie umiejętności analizy problemu, doboru odpowiedniej struktury danych oraz optymalizacji rozwiązania pod względem złożoności czasowej i pamięciowej.  
